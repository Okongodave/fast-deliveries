...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
   ...
   //   }
	...
	$mql = "INSERT INTO users(f_name,l_name,email,phone,password,address) VALUES('".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['email']."','".$_POST['phone']."','".md5($_POST['password'])."','".$_POST['address']."')";
	mysqli_query($db, $mql);
